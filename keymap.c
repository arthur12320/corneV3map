...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_CONFIG] = LAYOUT_split_3x6_3(
        ...
        RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, XXXXXXX, XXXXXXX,          KC_VOLU, KC_MNXT, KC_MPLY, XXXXXXX, XXXXXXX, GAME_OFF,
        RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, XXXXXXX, XXXXXXX,          KC_VOLD, KC_MPRV, XXXXXXX, XXXXXXX, XXXXXXX, GAME_ON,
    ...
    /* Unturned layer
    * ,-----------------------------------.   ,-----------------------------------.
    * | tab |  t  |  q  |  w  |  e  |  r  |   |  y  |  u  |  i  |  o  |  p  | bck |     
    * |-----+-----+-----+-----+-----+-----|   |-----+-----+-----+-----+-----+-----|
    * | sft |     |  a  |  s  |  d  |  f  |   |  h  |  j  |  k  |  l  |  ;  |  '  |
    * |-----+-----+-----+-----+-----+-----|   |-----+-----+-- --+-----+-----+-----|
    * | ctl |  z  |  x  |  c  |  v  |  g  |   |  n  |  m  |  ,  |  .  |  /  | esc |
    * `-----------------+-----+-----+-----|   |-----+-----+-----+-----------------'
    *                   | gui | fn1 | ent |   | spc | fn2 | alt |
    *                   `-----+-----+-----'   `-----+-----+-----'
    */
    ...
    [_UNT] = LAYOUT_split_3x6_3(
        ...
        KC_LSFT, XXXXXXX, KC_A,    KC_S,    KC_D,      KC_F,             KC_H,   KC_J,         KC_K,    KC_L,   KC_SCLN, KC_QUOT,
        KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,      KC_G,             KC_N,   KC_M,         KC_COMM, KC_DOT, KC_SLSH, KC_ESC,
